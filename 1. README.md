...
Sometimes it can be a bit difficult to know which pins on the Micro:bit are digital and which are analog.
Pins 0–2 and 12–16 can be used as analog output pins and 0-2 for analog input.
Pins 1, 2, 5, 8, 9, and 11–16 can be used as digital input pins.
